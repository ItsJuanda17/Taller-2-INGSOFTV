...
tasks.withType<Test> {
    ...
    // After Testcontainers spawns Postgres, it polls the published port to
    // verify readiness. By default it polls "localhost", but the test JVM
    // lives in the Jenkins container, where localhost is NOT the host.
